    ...
    <div className="flex justify-center items-center mt-8 border-zinc-300 border-b-2">
      <div className="flex items-center flex-col  ">
        ...
        <div className="flex m-5 lg:m-10  flex-col lg:flex-row  text-black  ">
          ...
          <div className="flex  items-left flex-col  p-3 lg:p-10 bg-[#fef9ea] border-yellow-400 border-2 shadow-cyan-500/50  rounded-2xl lg:mr-5  mb-4">
          ...
          <div className="flex  items-left flex-col p-3 lg:p-10  bg-[#c9dbf5] border-cyan-400 border-2 shadow-cyan-500/50  rounded-2xl lg:mr-5 mb-4">
