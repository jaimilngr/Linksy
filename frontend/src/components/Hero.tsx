function Hero() {
    return (
      <div className='flex items-center justify-center flex-col w-full py-14 px-36'>
        <div className='text-4xl font-bold lg:text-6xl  text-text text-center whitespace-pre-line'>
